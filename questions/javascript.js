const data = [
    ...
    {
        name: 'Enhancing user interfaces',
        type: 'list',
    ...
    {
        name: 'To execute a function when an event occurs',
        type: 'list',
    ...
    {
        name: 'To transform elements in an array',
        type: 'list',
    ...
    {
        name: 'The number is converted to a string and concatenated',
        type: 'list',
    ...
    {
        name: 'To execute a function for each element in an array',
        type: 'list',
